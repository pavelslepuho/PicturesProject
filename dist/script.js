...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_1__["default"])('.main-slider-item', 'fadeInDown');
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_1__["default"])('.feedback-slider-item', 'fadeInLeft', '.main-next-btn', '.main-prev-btn');
  ...
  Object(_modules_accordeon__WEBPACK_IMPORTED_MODULE_9__["default"])();
});
...
var accordeon = function accordeon() {
  var accordionBlock = document.querySelectorAll('.accordion-heading');
  accordionBlock.forEach(function (item) {
    ...
    item.addEventListener('click', function () {
      ...
      accordionBlock.forEach(function (block) {
...
var calc = function calc() {
  ...
  function calcResult(block, event) {
    block.addEventListener(event, function () {
      if (!size.value || !material.value) {
        ...
        resultBlock.textContent = "".concat(result, " BYN");
      } else {
  ...
  form.addEventListener('submit', function () {
    ...
    var response = fetch('http://localhost:3000/calc', {
      method: 'POST',
      headers: {
...
var modals = function modals() {
  var generalClientWidth = document.documentElement.clientWidth,
      btnPressed = false;

  function bindModal(triggerSelector, modalDialogSelector, modalCloseSelector) {
  ...
  function showModal(modalDialog) {
    ...
    var modalClientWidth = document.documentElement.clientWidth;
  ...
  function showModalByScroll(modalSelector, button) {
    ...
    window.addEventListener('scroll', function scroll() {
      if (window.pageYOffset + document.documentElement.clientHeight >= document.body.scrollHeight - 20 && !btnPressed) {
        ...
        showModal(modal);
        destroy = true ? document.querySelector(button).remove() : undefined;
...
var pictureSize = function pictureSize(imgSelector) {
  var pictures = document.querySelectorAll(imgSelector);
    ...
    item.addEventListener('mouseover', function () {
      item.children.forEach(function (elem) {
        if (elem.tagName === "P") {
          ...
          elem.setAttribute('src', "../assets/img/sizes-".concat(i + 1, "-1.png"));
        }
      });
    });
  });
    ...
    item.addEventListener('mouseout', function () {
      item.children.forEach(function (elem) {
        if (elem.tagName === "P") {
          ...
          elem.setAttribute('src', "../assets/img/sizes-".concat(i + 1, ".png"));
        }
      });
    });
  });
...
var showMoreStyles = function showMoreStyles() {
  ...
  /*#__PURE__*/
  function () {
    function Style(src, title, link, parentSelector) {
...
var sliders = function sliders(sliderSelector, direction, nextSelector, prevSelector) {
  var sliderItem = document.querySelectorAll(sliderSelector),
  ...
  sliderItem[0].parentElement.addEventListener('mouseover', function () {
    clearInterval(sliderTimer);
  });
  sliderItem[0].parentElement.addEventListener('mouseout', function () {
    sliderTimer = setInterval(autoSlide, 3000);
  });
